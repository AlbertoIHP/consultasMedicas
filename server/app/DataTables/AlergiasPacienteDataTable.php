...
class AlergiasPacienteDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ->eloquent($this->query())
            ->addColumn('action', 'alergias_pacientes.datatables_actions')
            ->make(true);
    }
    ...
    {
        $alergiasPacientes = AlergiasPaciente::query();

        return $this->applyScopes($alergiasPacientes);
    }
