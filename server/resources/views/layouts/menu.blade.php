...
<li class="{{ Request::is('estadoCitas*') ? 'active' : '' }}">
    <a href="{!! route('estadoCitas.index') !!}"><i class="fa fa-edit"></i><span>EstadoCitas</span></a>
</li>
...
<li class="{{ Request::is('atentions*') ? 'active' : '' }}">
    <a href="{!! route('atentions.index') !!}"><i class="fa fa-edit"></i><span>Atentions</span></a>
</li>
...
<li class="{{ Request::is('diagnosticoAtencions*') ? 'active' : '' }}">
    <a href="{!! route('diagnosticoAtencions.index') !!}"><i class="fa fa-edit"></i><span>DiagnosticoAtencions</span></a>
</li>

<li class="{{ Request::is('boxConsultas*') ? 'active' : '' }}">
    <a href="{!! route('boxConsultas.index') !!}"><i class="fa fa-edit"></i><span>BoxConsultas</span></a>
</li>
...
<li class="{{ Request::is('tipoBoxes*') ? 'active' : '' }}">
    <a href="{!! route('tipoBoxes.index') !!}"><i class="fa fa-edit"></i><span>TipoBoxes</span></a>
</li>
...
<li class="{{ Request::is('viaAdministracionMedicamentos*') ? 'active' : '' }}">
    <a href="{!! route('viaAdministracionMedicamentos.index') !!}"><i class="fa fa-edit"></i><span>ViaAdministracionMedicamentos</span></a>
</li>

<li class="{{ Request::is('recetaMedicamentos*') ? 'active' : '' }}">
