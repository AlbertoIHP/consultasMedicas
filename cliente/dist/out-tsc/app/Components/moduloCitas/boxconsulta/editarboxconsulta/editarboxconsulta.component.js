...
var EditarboxconsultaComponent = /** @class */ (function () {
    ...
    EditarboxconsultaComponent.prototype.ngOnInit = function () {
        this.editarForm = new forms_1.FormGroup({
            ubicacion: new forms_1.FormControl(this.boxConsulta.ubicacion, [forms_1.Validators.required]),
            tipoBox: new forms_1.FormControl(this.boxConsulta.TipoBox_id, [forms_1.Validators.required]),
        });
    };
