...
var EditarestadocitaComponent = /** @class */ (function () {
    ...
    EditarestadocitaComponent.prototype.ngOnInit = function () {
        this.editarForm = new forms_1.FormGroup({
            nombre: new forms_1.FormControl(this.estadocita.nombre, [forms_1.Validators.required]),
            descripcion: new forms_1.FormControl(this.estadocita.descripcion, [forms_1.Validators.required]),
        });
    };
