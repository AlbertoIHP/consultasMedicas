...
var EditarespecialidadComponent = /** @class */ (function () {
    function EditarespecialidadComponent(
    ...
    EditarespecialidadComponent.prototype.ngOnInit = function () {
    ...
    //Cerrar el diálogo
    EditarespecialidadComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    EditarespecialidadComponent.prototype.editarEspecialidad = function () {
        var _this = this;
        //Usando el id de la especialidad, se actualiza con los nuevos datos
        this.servicioEspecialidad.editEspecialidad(this.especialidad, this.especialidad.id).subscribe(function (data) {
            //Se emite un evento para no actualizar la vista
            _this.servicioEvento.actualizacion(true);
            _this.dialogRef.close();
        });
    };
    EditarespecialidadComponent = __decorate([
        core_1.Component({
    ...
    return EditarespecialidadComponent;
}());
exports.EditarespecialidadComponent = EditarespecialidadComponent;
//# sourceMappingURL=editarespecialidad.component.js.map