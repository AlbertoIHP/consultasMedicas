...
var RegistroComponent = /** @class */ (function () {
    function RegistroComponent(dialogRef, data, _formBuilder, servicioPersona, servicioRegion, servicioProvincia, servicioComuna, servicioGenero, servicioEstadoCivil, router, servicioEventos, servicioUsuario, servicioRole, dateAdapter) {
    ...
    RegistroComponent.prototype.agregarPersona = function () {
        var _this = this;
        if (!this.seEncontro) {
            this.nuevaPersona.fechaNacimiento = new Date(this.date.value).toISOString().slice(0, 19).replace('T', ' ');
