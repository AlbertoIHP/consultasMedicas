...
var FichaAtencionComponent = /** @class */ (function () {
    function FichaAtencionComponent(dialogRef, data, servicioVistaPaciente) {
    ...
    FichaAtencionComponent.prototype.obtenerDatosPaciente = function () {
        var _this = this;
    ...
    FichaAtencionComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    FichaAtencionComponent = __decorate([
        core_1.Component({
    ...
    return FichaAtencionComponent;
}());
exports.FichaAtencionComponent = FichaAtencionComponent;
//# sourceMappingURL=ficha-atencion.component.js.map