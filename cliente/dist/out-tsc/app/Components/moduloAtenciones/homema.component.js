...
var Homema = /** @class */ (function () {
    function Homema(deviceService, eventosService, router, servicioUsuario) {
    ...
    Homema.prototype.ngOnInit = function () {
    };
    Homema = __decorate([
        core_1.Component({
            selector: 'app-homema',
...
exports.Homema = Homema;
//# sourceMappingURL=homema.component.js.map