...
var EstadocivilComponent = /** @class */ (function () {
    function EstadocivilComponent(servicioEstadoCivil, dialog, router) {
    ...
    EstadocivilComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataSource = new datasource_component_1.ExampleDataSource(new datasource_component_1.ExampleDatabase([]), this.paginator, this.sort, 'EC');
    ...
    EstadocivilComponent.prototype.isAllSelected = function () {
        if (!this.dataSource) {
            return false;
        }
    ...
    EstadocivilComponent.prototype.masterToggle = function () {
        var _this = this;
        if (!this.dataSource) {
            return;
        }
    ...
    EstadocivilComponent.prototype.actualizarEstadoCiviles = function () {
        ...
        this.servicioEstadoCivil.getEstadoCivils().subscribe(function (data) {
            ...
            //DATATABLE
            _this.exampleDatabase = new datasource_component_1.ExampleDatabase(_this.totalEstadoCiviles);
            _this.dataSource = new datasource_component_1.ExampleDataSource(_this.exampleDatabase, _this.paginator, _this.sort, 'EC');
    ...
    ], EstadocivilComponent.prototype, "sort", void 0);
    __decorate([
    ...
    EstadocivilComponent = __decorate([
        ...
        __metadata("design:paramtypes", [estadocivil_service_1.EstadocivilService,
