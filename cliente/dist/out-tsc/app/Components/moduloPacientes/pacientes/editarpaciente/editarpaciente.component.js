...
var EditarpacienteComponent = /** @class */ (function () {
    ...
    EditarpacienteComponent.prototype.ngOnInit = function () {
        ...
        this.editarForm = new forms_1.FormGroup({
            tipoSangre: new forms_1.FormControl(this.paciente.TipoSangre_id, [forms_1.Validators.required]),
            grupoEtnico: new forms_1.FormControl(this.paciente.GrupoEtnico_id, [forms_1.Validators.required]),
            ocupacion: new forms_1.FormControl(this.paciente.Ocupacion_id, [forms_1.Validators.required])
        });
    };
