...
var VerFichaMedicaComponent = /** @class */ (function () {
    function VerFichaMedicaComponent(servicioPersona, servicioRegion, servicioProvincia, servicioComuna, servicioGenero, servicioEstadoCivil, servicioTipoSangre, servicioPrevisionActual, servicioPrevision, servicioPaciente, dialogRef, data) {
        ...
        this.displayedColumns1 = ['Nombres', 'Apellidos', 'RUT'];
        ...
        this.columnasAlergia = ['id', 'NombreComun', 'NombreCientifico'];
    ...
    //-------Datos Paciente
    VerFichaMedicaComponent.prototype.obtenerListaPacientes = function (id) {
        var _this = this;
    ...
    VerFichaMedicaComponent.prototype.obtenerPaciente = function (id) {
    ...
    VerFichaMedicaComponent.prototype.obtenerTipoSangre = function (id) {
        var _this = this;
    ...
    VerFichaMedicaComponent.prototype.reconocerActivado = function () {
        var persona = new Persona_model_1.Persona();
    ...
    */
    ...
    VerFichaMedicaComponent.prototype.obtenerPersonaPaciente = function (id) {
        var _this = this;
    ...
    VerFichaMedicaComponent.prototype.obtenerComunaPaciente = function (id) {
        var _this = this;
    ...
    VerFichaMedicaComponent.prototype.obtenerProvinciaPaciente = function (id) {
        var _this = this;
    ...
    VerFichaMedicaComponent.prototype.obtenerRegionPaciente = function (id) {
        var _this = this;
    ...
    //se obtiene el género del paciente
    VerFichaMedicaComponent.prototype.obtenerGeneroPaciente = function (id) {
        var _this = this;
    ...
    //se obtiene el estado civil del paciente
    VerFichaMedicaComponent.prototype.obtenerEstadoCivilPaciente = function (id) {
        var _this = this;
    ...
    VerFichaMedicaComponent.prototype.obtenerPrevisionActual = function (id) {
        var _this = this;
    ...
    VerFichaMedicaComponent.prototype.obtenerPrevision = function (id) {
        var _this = this;
    ...
    VerFichaMedicaComponent.prototype.ordenarHistorial = function (historial) {
