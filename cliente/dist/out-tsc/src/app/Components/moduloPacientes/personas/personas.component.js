...
var PersonaComponent = /** @class */ (function () {
    ...
    PersonaComponent.prototype.cambiarBusqueda = function () {
    ...
    PersonaComponent.prototype.actualizarPersonas = function () {
        ...
        this.servicioPersona.getPersonas().subscribe(function (data) {
            ...
            _this.dataSource = new datasource_component_1.dataTable(_this.exampleDatabase, _this.paginator);
            _this.dataSource2 = new datasource_component_1.buscadorPorNombre(_this.exampleDatabase, 'Persona');
            Observable_1.Observable.fromEvent(_this.filter.nativeElement, 'keyup')
                .debounceTime(150)
                .distinctUntilChanged()
                .subscribe(function () {
                if (!_this.dataSource2) {
                    return;
                }
                _this.dataSource2.filter = _this.filter.nativeElement.value;
            });
        });
    };
